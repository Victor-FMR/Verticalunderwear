...
export const createdPaymentMethods = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const newPaymentMethod = await Prisma.paymentMethods.create({
      data: {
        numeroTarjeta: numberScript as string,
        nombreTitular: nombreTitular,
        monthVencimiento: monthScript as string,
        yearVencimiento: yearScript as string,
        codigoSeguridad: codeScript as string,
...
export const putPaymentMethods = async (req: Request, res: Response) => {
  const userId = req.user as User;
