...
export const createpaypalOrder = async (req: Request) => {
  ...
  try {
    ...
    const countryName = (checkoutSession.information as ShippingAddress)
      .country as string;
    ...
    const order = {
      ...
      purchase_units: [
        {
          reference_id: PAYPAL_API, // The reference ID for the transaction in your system.
          amount: {
            currency_code: "USD",
            value: "10", //checkoutSession.totalAmount, // The amount of the transaction in the currency specified above.
            breakdown: {
              item_total: {
                currency_code: "USD",
          ...
          shipping: {
            name: {
              full_name:
                `${
                  (checkoutSession.information as ShippingAddress).first_name
                } ${
                  (checkoutSession.information as ShippingAddress).last_name
                }` || "",
            },

            address: {
              address_line_1:
                (checkoutSession.information as ShippingAddress)
                  .address_line_1 || "",
              address_line_2:
                (checkoutSession.information as ShippingAddress)
                  .address_line_2 || "",
              ...
              admin_area_2:
                (checkoutSession.information as ShippingAddress).city || "", // La ciudad
              postal_code:
                (checkoutSession.information as ShippingAddress).zipcode || "", // El código postal
